...
const categories = [
  { name: "NADRA", slug: "nadra", icon: "Fingerprint", description: "Identity cards and citizen registration" },
  { name: "Passport", slug: "passport", icon: "FileText", description: "Machine-readable and e-passport services" },
  { name: "Driving License", slug: "driving-license", icon: "Car", description: "Learner permits and permanent driving licenses" },
  { name: "HEC Scholarships", slug: "scholarships", icon: "GraduationCap", description: "Higher education commission funding programs" },
  { name: "Business Setup", slug: "business-registration", icon: "Briefcase", description: "SECP company setup and NTN registration" },
  { name: "Tax & FBR", slug: "tax-fbr", icon: "Hash", description: "FBR tax registration, active tax status checks, and income tax filing guides" },
  { name: "Utility Services", slug: "utilities", icon: "Lightbulb", description: "Electricity, gas, and water new connections and complaint registrations" },
  { name: "Police & Legal", slug: "police-legal", icon: "ShieldAlert", description: "FIR guide, character certificate, and civil court procedures" },
  { name: "Healthcare", slug: "healthcare", icon: "HeartPulse", description: "Sehat Sahulat card, vaccination guides, and medical certificates" },
  { name: "Employment", slug: "employment", icon: "Briefcase", description: "Government jobs, PPSC/FPSC exams, and interview prep guides" },
];
...
const staticServices = [
  // 1. NADRA
  {
    ...
    fees: [
      { title: "Normal CNIC (30 Days)", amount: 750 },
      { title: "Urgent CNIC (15 Days)", amount: 1500 },
      { title: "Executive CNIC (7 Days)", amount: 2500 }
    ],
    steps: [
  ...
  },
  {
    ...
    fees: [
      { title: "Normal Renewal", amount: 750 },
      { title: "Urgent Renewal", amount: 1500 },
      { title: "Executive Renewal", amount: 2500 }
    ],
    steps: [
  ...
  // 2. Passports
  {
    ...
    fees: [
      { title: "5 Years Validity (36 Pages) - Normal", amount: 3000 },
      { title: "5 Years Validity (36 Pages) - Urgent", amount: 5000 },
      { title: "10 Years Validity (36 Pages) - Normal", amount: 4500 },
      { title: "10 Years Validity (36 Pages) - Urgent", amount: 7500 }
    ],
    steps: [
  ...
  // 3. Driving License
  {
    ...
    fees: [
      { title: "Learner Ticket Fee (per category)", amount: 500 }
    ],
    steps: [
  ...
  // 4. HEC Scholarships
  {
    ...
    fees: [
      { title: "HEC HAT Entry Test Fee", amount: 2000 }
    ],
    steps: [
  ...
  // 5. Business Setup
  {
    ...
    fees: [
      { title: "Name Reservation Fee", amount: 200 },
      { title: "Incorporation filing (Online)", amount: 1500 },
      { title: "Digital Signature Certificate (per director)", amount: 1000 }
    ],
    steps: [
  ...
  // 6. Tax & FBR
  {
    ...
    fees: [
      { title: "FBR Online Registration", amount: 0 }
    ],
    steps: [
  ...
  },
  {
    ...
    fees: [
      { title: "Active Status Check", amount: 0 },
      { title: "Late Filer ATL Surcharge (Individuals)", amount: 1000 }
    ],
    steps: [
  ...
  },
  {
    ...
    fees: [
      { title: "Certificate Download", amount: 0 }
    ],
    steps: [
  ...
  // 7. Utility Services
  {
    ...
    fees: [
      { title: "Complaint Registration", amount: 0 }
    ],
    steps: [
  ...
  },
  {
    ...
    fees: [
      { title: "Gas Complaint Registration", amount: 0 }
    ],
    steps: [
  ...
  },
  {
    ...
    fees: [
      { title: "Water Supply Complaint Registration", amount: 0 }
    ],
    steps: [
  ...
  },
  {
    ...
    fees: [
      { title: "Electricity Meter Demand Notice (Single Phase)", amount: 7500 },
      { title: "Gas Connection Fee (Domestic)", amount: 6000 }
    ],
    steps: [
  ...
  },
  {
    ...
    fees: [
      { title: "Bill Correction filing", amount: 0 }
    ],
    steps: [
  ...
  // 8. Police & Legal
  {
    ...
    fees: [
      { title: "FIR Registration", amount: 0 }
    ],
    steps: [
  ...
  },
  {
    ...
    fees: [
      { title: "Complaint Submission", amount: 0 }
    ],
    steps: [
  ...
  },
  {
    ...
    fees: [
      { title: "Processing Fee (via e-Khidmat / Police Khidmat)", amount: 500 }
    ],
    steps: [
  ...
  },
  {
    ...
    fees: [
      { title: "Challan Processing", amount: 100 }
    ],
    steps: [
  ...
  },
  {
    ...
    fees: [
      { title: "Court stamp paper fee (Max limit)", amount: 15000 }
    ],
    steps: [
  ...
  // 9. Healthcare
  {
    ...
    fees: [
      { title: "Registration & Coverage", amount: 0 }
    ],
    steps: [
  ...
  },
  {
    ...
    fees: [
      { title: "Vaccination Doses", amount: 0 },
      { title: "NADRA Certificate Issuance Fee", amount: 250 }
    ],
    steps: [
  ...
  },
  {
    ...
    fees: [
      { title: "OPD Registration Ticket", amount: 10 },
      { title: "Inpatient stay & basic medicines", amount: 0 }
    ],
    steps: [
  ...
  },
  {
    ...
    fees: [
      { title: "Information Guide", amount: 0 }
    ],
    steps: [
  ...
  },
  {
    ...
    fees: [
      { title: "Lab tests (Urinalysis, Chest X-ray, Blood tests)", amount: 500 }
    ],
    steps: [
  ...
  // 10. Employment
  {
    ...
    fees: [
      { title: "NJP Job Application", amount: 0 }
    ],
    steps: [
  ...
  },
  {
    ...
    fees: [
      { title: "PPSC Challan fee (NBP/SBP branches)", amount: 600 }
    ],
    steps: [
  ...
  },
  {
    ...
    fees: [
      { title: "FPSC Challan Fee (BS-16 to BS-17)", amount: 300 },
      { title: "FPSC Challan Fee (BS-18)", amount: 750 },
      { title: "CSS Exam Challan Fee", amount: 2200 }
    ],
    steps: [
  ...
  },
  {
    ...
    fees: [
      { title: "Template Download", amount: 0 }
    ],
    steps: [
  ...
  },
  {
    ...
    fees: [
      { title: "Prep Guide Access", amount: 0 }
    ],
    steps: [
...
async function main() {
  ...
  for (const svc of staticServices) {
    const categoryId = catMap[svc.categorySlug];
    if (!categoryId) {
      console.warn(`Category slug ${svc.categorySlug} not found.`);
      continue;
    }

    console.log(`Processing service: ${svc.title}`);
    
    // Create/upsert the service
    const serviceData = {
      categoryId,
      title: svc.title,
      slug: svc.slug,
      ...
      baseFee: svc.baseFee,
      officialSourceUrl: svc.officialSourceUrl,
      isPublished: true, // Crucial for being visible
    };
    ...
    // Seed relations: delete old first, then add new to avoid duplication
